        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              // Amount summary pill — reminds user what they're sending
...
class _AmountSummaryPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.swap_horiz, color: AppColors.secondaryColor, size: 18),
          ...
          const Icon(Icons.arrow_forward, size: 14, color: AppColors.textColor2),
          Text(
